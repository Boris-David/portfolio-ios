...
/// Le chrome se **dérive** de la langue portée par l'environnement, plutôt que
/// d'être une seconde valeur d'environnement.
///
/// Deux clés — une pour la langue, une pour le chrome — auraient pu se
/// contredire : il aurait suffi d'oublier d'en mettre une à jour. Une seule
/// source rend la contradiction impossible.
@propertyWrapper
