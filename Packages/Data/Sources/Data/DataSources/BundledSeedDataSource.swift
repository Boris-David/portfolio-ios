...
public struct BundledSeedDataSource: SeedProviding {
  ...
  public init(bundle: Bundle = BundledSeedDataSource.resources, builtAt: Date? = nil) {
    self.bundle = bundle
    self.builtAt = builtAt ?? BundledSeedDataSource.compiledAt(bundle: bundle)
  }
  ...
  /// than none at all.
  public static func compiledAt(bundle: Bundle = BundledSeedDataSource.resources) -> Date {
